...
public class SessionAggrStatAccumulator implements AccumulatorParam<String> {
	...
	public String zero(String v) {
		return Constants.SESSION_COUNT + "=0|"
				...
				+ Constants.SEX_MALE + "=0|"
				+ Constants.SEX_FEMALE + "=0|"
				+ Constants.CITY + "=0|"
				+ Constants.AGE_PERIOD_0_17 + "=0|"
				+ Constants.AGE_PERIOD_18_24 + "=0|"
				+ Constants.AGE_PERIOD_25_34 + "=0|"
				+ Constants.AGE_PERIOD_35_44 + "=0|"
				+ Constants.AGE_PERIOD_45_54 + "=0|"
				+ Constants.AGE_PERIOD_55_100 + "=0|"
				+ Constants.PROFESSIONAL + "=0";
	}
